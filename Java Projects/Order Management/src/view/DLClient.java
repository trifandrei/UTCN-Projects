...
public class DLClient {
	...
	private JButton delclient=new JButton("Sterge");
	...
	public DLClient() {
		...
		JLabel txt=new JLabel("Aici puteti sterge un client!!");
		...
		panel1.add(delclient).setBounds(40, 150, 100, 40);
		...
		delclient.addActionListener(new ActionListener() {
			public  void actionPerformed(ActionEvent e) {
				...
				try {
					Method method1=ConnectionDB.class.getDeclaredMethod("deleteClienti",String.class,String.class);
					method1.invoke(null,a1,a2);
					text.append("Clientul a fost sters!!\n");
			 	}catch(Exception e1) {
